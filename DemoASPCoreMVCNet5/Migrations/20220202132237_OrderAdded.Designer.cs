...
namespace DemoASPCoreMVCNet5.Migrations
{
    ...
    [Migration("20220202132237_OrderAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrderPaced")
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.OrderDetail", b =>
                {
                    b.HasOne("DemoASPCoreMVCNet5.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DemoASPCoreMVCNet5.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DemoASPCoreMVCNet5.Models.Pie", b =>
                {
                    b.HasOne("DemoASPCoreMVCNet5.Models.Category", "Category")
                        .WithMany("Pies")
